...
Inspired by Josh Wardle's fantastic (and very popular) [Wordle](https://www.powerlanguage.co.uk/wordle/), I decided to add another spin-off to the fast and ever growing world of Wordle-derivatives.
The goal in Survivle is, opposite to the original, to take as many guesses as possible before entering the secret word.


"But that is easy", I hear you say, "I can just enter XYLYL until the heat death of the universe occurs". Ha! — if only it was that easy. To foil that plan, the game must be played in hardmode, i.e. all revealed information must be used.
...
(My personal record is 9, with some obscenely lucky guesses) 
